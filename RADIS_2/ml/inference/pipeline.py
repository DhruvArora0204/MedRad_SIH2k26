...
def load_image_tensor(image_path: str, target_size=(256, 256)) -> np.ndarray:
    """
    Loads PNG, JPG, JPEG, or DICOM image and returns normalized (3, H, W) numpy array.
    """
...
def run_pipeline(dicom_path: str, model_weights_path: str, target_size=(256, 256), prob_threshold=0.5, study_id: str = "STD-001"):
    ...
    resized_np = load_image_tensor(dicom_path, target_size)
