...
METADATA_FILE = os.path.join(PROJECT_ROOT, "data", "scans_metadata.json")
...
class StorageService:
    ...
    def save_scan(self, filename: str, content: bytes, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
